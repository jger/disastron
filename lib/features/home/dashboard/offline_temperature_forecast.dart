...
Future<ClimateNormalsPack> loadBundledClimateNormalsPack() async {
  final String s =
      await rootBundle.loadString('assets/data/climate_normals.json');
  return ClimateNormalsPack.fromJson(
