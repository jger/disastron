...
final FutureProvider<DashboardDeviceSnapshot> dashboardDeviceProvider =
    FutureProvider.autoDispose<DashboardDeviceSnapshot>((Ref ref) async {
  ...
  if (perm == LocationPermission.denied ||
    ...
    locErr = 'Location permission denied';
  } else {
    try {
      final bool serviceOn = await Geolocator.isLocationServiceEnabled();
      if (!serviceOn) {
        locErr = 'Location services disabled';
      } else {
